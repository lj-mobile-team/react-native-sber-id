...
#ifndef SBERBANKSDK_SWIFT_H
#define SBERBANKSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SberbankSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP11SberbankSDK27LoginButtonObserverProtocol_")
...
enum SBKTrinity : NSInteger;

/// Менеджер авторизации
SWIFT_CLASS("_TtC11SberbankSDK14SBKAuthManager")
...
///   </li>
/// </ul>
+ (void)authWithSberId:(SBKAuthRequest * _Nonnull)request viewController:(UIViewController * _Nullable)viewController;
...
+ (BOOL)soleLoginWebPageAuthWithSberIdRequest:(SBKAuthRequest * _Nonnull)request svcRedirectUrlString:(NSString * _Nonnull)svcRedirectUrlString viewController:(UIViewController * _Nonnull)viewController SWIFT_WARN_UNUSED_RESULT;
/// Получить объект ответа
/// \param url url с которого был переход
///
/// \param completion блок, возвращающий объект ответа
///
+ (void)getResponseFrom:(NSURL * _Nonnull)url completion:(SWIFT_NOESCAPE void (^ _Nonnull)(SBKAuthResponse * _Nonnull))completion;
...
///
/// \param isSuccess флаг успешности входа
///
/// \param userStatus флаг, впервые ли пользователь регистрируется
///
+ (void)sendOtherAuthWithServiceName:(NSString * _Nonnull)serviceName isSuccess:(enum SBKTrinity)isSuccess userStatus:(enum SBKTrinity)userStatus;
/// Передать метрики использования сервисов авторизации, отличных от Сбер ID
/// \param service сервис, который использовал пользователь
///
/// \param isSuccess флаг успешности входа
///
/// \param isUserNew флаг, впервые ли пользователь регистрируется
///
+ (void)sendOtherAuthWithService:(enum AuthServiceType)service isSuccess:(enum SBKTrinity)isSuccess isUserNew:(enum SBKTrinity)isUserNew;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Модель запроса
SWIFT_CLASS("_TtC11SberbankSDK14SBKAuthRequest")
...
///
- (nonnull instancetype)initWithClientId:(NSString * _Nonnull)clientId scope:(NSString * _Nonnull)scope state:(NSString * _Nonnull)state nonce:(NSString * _Nonnull)nonce ssoBaseUrl:(NSString * _Nullable)ssoBaseUrl redirectUri:(NSString * _Nonnull)redirectUri codeChallenge:(NSString * _Nullable)codeChallenge codeChallengeMethod:(NSString * _Nullable)codeChallengeMethod OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC11SberbankSDK15SBKAuthResponse")
...
SWIFT_CLASS("_TtC11SberbankSDK14SBKLoginButton")
...
///
- (nonnull instancetype)initWithType:(enum LoginButtonStyle)type clientId:(NSString * _Nonnull)clientId observer:(id <LoginButtonObserverProtocol> _Nullable)observer;
/// Инициализатор
/// \param type стиль кнопки
///
...
/// \param observer наблюдатель состояния кнопки
///
- (nonnull instancetype)initWithType:(enum LoginButtonStyle)type textType:(enum LoginButtonTextType)textType clientId:(NSString * _Nonnull)clientId desiredSize:(CGSize)desiredSize observer:(id <LoginButtonObserverProtocol> _Nullable)observer;
...
///
- (void)setCornerRadius:(enum CornerRadiusStyle)radiusStyle;
...
typedef SWIFT_ENUM(NSInteger, SBKTrinity, open) {
/// Позитивный
  SBKTrinityTrue = 0,
/// Негативный
  SBKTrinityFalse = 1,
...
SWIFT_CLASS("_TtC11SberbankSDK8SBKUtils")
...
/// Полученное значение необходимо передать при создании SBKAuthRequest в параметр ssoBaseUrl.
